# Olá, sou o Marcos Felisberto! 👋
### Desenvolvedor Java Full Stack | Especialista em Modernização & Cloud

Sou um engenheiro de software apaixonado por transformar sistemas legados em arquiteturas modernas. Atualmente na **Stefanini**, atuo na interseção entre o mundo corporativo robusto (Oracle/SOA) e a inovação (Microsserviços/Cloud).

- 🔭 **Trabalhando atualmente em:** Modernização de sistemas críticos e integrações via Oracle OIC.
- 🌱 **Estudando:** Pós-graduação em **Arquitetura de Software** na FIAP (Clean Arch, DDD, Event-Driven).
- 💡 **Especialidades:** Java (8-21), Spring Boot, Oracle Cloud (OCI), Arquitetura Hexagonal.
- 🧪 **Qualidade:** Forte background em QA, sempre priorizo TDD/BDD e automação (Selenium/Cucumber).
...
### 📊 GitHub Stats
![GitHub stats](https://github-readme-stats.vercel.app/api?username=MSFelisberto&show_icons=true&theme=dracula)

### Linkedin
![Perfil Linkedin](https://www.linkedin.com/in/msfelisberto/)
